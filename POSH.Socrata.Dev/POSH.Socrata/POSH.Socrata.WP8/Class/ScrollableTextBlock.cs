...
namespace POSH.Socrata.WP8.Class
{
    public class ScrollableTextBlock : Control
    {
        ...
        private void ParseTextHide(string value)
        {
            ...
            {
                int textBlockSize = value.Length / maxTexCount;
                int start = 0;
                ...
                {
                    TextBlock textBlock = this.GetTextBlock();
                    textBlock.Text = value.Substring(maxTexCount * textBlockSize, value.Length - maxTexCount * textBlockSize);
                    this.stackPanel.Children.Add(textBlock);
                }
            }
        }
        ...
        private int GetMaxTextSize()
        {
            ...
            // Get line count
            int lineCount = (int)(POSH.Socrata.Entity.Models.Constant.MaxTextBlockLength / size.Height);
        ...
        private int GetMaxLineCount()
        {
            ...
            int charLineCount = (int)(this.Width / size.Width);
            // Get line count
            int lineCount = (int)(POSH.Socrata.Entity.Models.Constant.MaxTextBlockLength / size.Height) - 5;
